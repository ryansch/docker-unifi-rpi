...
- [`6.0.28`, `6.0`, `6`, `latest` (*v6.0.28/6.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/v6.0.28/6.0)
- [`6.0.33` (*6.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/6.0)
- [`6.1.23` (*6.1*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/6.1)
