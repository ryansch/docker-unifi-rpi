...
- [`5.11.50` `5.11`, `5`, `latest` (*v5.11.50/5.11*)](https://github.com/ryansch/docker-unifi-rpi/blob/v5.11.50/5.11)
- [`5.12.22` (*5.12*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/5.12)
