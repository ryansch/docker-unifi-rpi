...
- [`6.5.55`, `6.5`, `6` (*v6.5.55/6.5*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/v6.5.55/6.5)
- [`7.0.23`, `7.0`, `7`, `latest` (*v7.0.23/7.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/v7.0.23/7.0)
- [`7.1.61` (*7.1*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/7.1)
