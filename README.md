...
- [`6.0.36`, `6.0`, `6`, `latest` (*v6.0.36/6.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/v6.0.36/6.0)
- [`6.0.37` (*6.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/6.0)
- [`6.1.26` (*6.1*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/6.1)
