...
- [`10.1.89`, `10.1`, `10`, `latest` (v10.1.89/10.1)](https://github.com/ryansch/docker-unifi-rpi/tree/v10.1.89/10.1)
- [`10.2.105`, (*10.2*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/10.2)
