...
- [`9.2.87`, `9.2`, `9`, `latest` (v9.2.87/9.2)](https://github.com/ryansch/docker-unifi-rpi/tree/v9.2.87/9.2)
- [`9.3.25` (*9.3*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/9.3)
