...
- [`5.10.27` `5.10` (*v5.10.27/5.10*)](https://github.com/ryansch/docker-unifi-rpi/blob/v5.10.27/5.10)
- [`5.11.47` `5.11`, `5`, `latest` (*v5.11.47/5.11*)](https://github.com/ryansch/docker-unifi-rpi/blob/v5.11.47/5.11)
- [`5.11.48` (*5.11*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/5.11)
- [`5.12.11` (*5.12*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/5.12)
