...
- [`6.0.45`, `6.0`, `6`, `latest` (*v6.0.45/6.0*)](https://github.com/ryansch/docker-unifi-rpi/blob/v6.0.45/6.0)
- [`6.1.57` (*6.1*)](https://github.com/ryansch/docker-unifi-rpi/blob/master/6.1)
