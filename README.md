...
- [`7.2.91` (*7.2*)](https://github.com/ryansch/docker-unifi-rpi/blob/main/7.2)

## Versions
⚠️  This project is beginning a transition from MongoDB 2.4 to 3.6. Direct upgrades are not yet possible! ⚠️
